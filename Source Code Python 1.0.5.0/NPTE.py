...
def build():
    ...
    code_parts.append(f'rmdir /s /q {python_file_name}.build')
    code_parts.append('pause')
    code_parts.append('del Build.bat')
    ...
    messagebox.showinfo("Success!", f"The file 'Build.bat' was built successfully at {output}")
